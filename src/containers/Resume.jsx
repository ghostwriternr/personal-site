      ...
      <div className="resume-container">
        ...
        <div className="resume-desc row">
          <div className="col-xs-offset-1 col-xs-10 tablet-landscape-invisible desktop-invisible">
            <p>
              The PDF version of my resume can be downloaded{" "}
              <a href="https://github.com/ghostwriternr/resume/raw/master/naresh_latest.pdf">
                from here
              </a>
            </p>
          </div>
        ...
        <div className="resume-img">
          <img src={require("../images/resume.jpg").default} alt="Resume" />
        </div>
