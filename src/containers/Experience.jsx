      ...
      <div className="experience-container">
        ...
        <div className="experience-desc row">
          <div className="col-xs-offset-1 col-xs-10 tablet-landscape-invisible desktop-invisible">
            <p>
              I graduated in 2018 with a Masters degree in Computer Science.
              During my stay at IIT Kharagpur, I had taken up several technical
              as well as directorial roles. I spent last summer with gRPC, a
              CNCF project, enabling building their Python code with Bazel.
            </p>
          </div>
        </div>
        <div className="experience-desc row">
            ...
            <div className="row exp-grid">
              <div className="col-xs-12 col-sm-6 col-md-4 box">
                <Link
                  id="intuit-box"
                  className="box-bg"
                  to={`${this.props.match.url}/intuit`}
                >
                  <img
                    className="org-logo"
                    src={require("../images/logos/intuit.png").default}
                    alt="Intuit"
                  />
                  <img
                    className="link-logo"
              ...
              <div className="col-xs-12 col-sm-6 col-md-4 box">
                <Link
                  id="ezdi-box"
                  className="box-bg"
                  to={`${this.props.match.url}/ezdi`}
                >
                  <img
                    className="org-logo"
                    src={require("../images/logos/ezdi.png").default}
                    alt="EzDI"
                  />
                  <img
                    className="link-logo"
              ...
              <div className="col-xs-12 col-sm-6 col-md-4 box">
                <Link
                  id="auv-box"
                  className="box-bg"
                  to={`${this.props.match.url}/auv`}
                >
                  <img
                    className="org-logo"
                    src={require("../images/logos/auv.png").default}
                    alt="AUV, IIT Kharagpur"
                  />
                  <img
                    className="link-logo"
                    src={require("../images/link.svg").default}
              ...
              <div className="col-xs-12 col-sm-6 col-md-4 box">
                <Link
                  id="metakgp-box"
                  className="box-bg"
                  to={`${this.props.match.url}/metakgp`}
                >
                  <img
                    className="org-logo"
                    src={require("../images/logos/metakgp.jpg").default}
                    alt="MetaKGP"
                  />
                  <img
                    className="link-logo"
              ...
              <div className="col-xs-12 col-sm-6 col-md-4 box">
                <Link
                  id="tls-box"
                  className="box-bg"
                  to={`${this.props.match.url}/tls`}
                >
                  <img
                    className="org-logo"
                    src={require("../images/logos/tls.jpg").default}
                    alt="TLS"
                  />
                  <img
                    className="link-logo"
              ...
              <div className="col-xs-12 col-sm-6 col-md-4 box">
                <Link
                  id="iitkgp-box"
                  className="box-bg"
                  to={`${this.props.match.url}/iitkgp`}
                >
                  <img
                    className="org-logo"
                    src={require("../images/logos/iitkgp.png").default}
                    alt="IITKGP"
                  />
                  <img
                    className="link-logo"
