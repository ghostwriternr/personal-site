            ...
            <div className="row exp-grid">
              <div className="col-xs-12 col-sm-6 col-md-4 box">
                ...
                >
                  <img
                    className="org-logo"
                    src={require ('../images/logos/intuit.png')}
                    alt="Intuit"
                  />
                  <img
                    className="link-logo"
              ...
              <div className="col-xs-12 col-sm-6 col-md-4 box">
                ...
                >
                  <img
                    className="org-logo"
                    src={require ('../images/logos/ezdi.png')}
                    alt="EzDI"
                  />
                  <img
                    className="link-logo"
              ...
              <div className="col-xs-12 col-sm-6 col-md-4 box">
                ...
                >
                  <img
                    className="org-logo"
                    src={require ('../images/logos/auv.png')}
              ...
              <div className="col-xs-12 col-sm-6 col-md-4 box">
                ...
                >
                  <img
                    className="org-logo"
                    src={require ('../images/logos/metakgp.jpg')}
                    alt="MetaKGP"
                  />
                  <img
                    className="link-logo"
              ...
              <div className="col-xs-12 col-sm-6 col-md-4 box">
                ...
                >
                  <img
                    className="org-logo"
                    src={require ('../images/logos/tls.jpg')}
                    alt="TLS"
                  />
                  <img
                    className="link-logo"
              ...
              <div className="col-xs-12 col-sm-6 col-md-4 box">
                ...
                >
                  <img
                    className="org-logo"
                    src={require ('../images/logos/iitkgp.png')}
                    alt="IITKGP"
                  />
                  <img
                    className="link-logo"
