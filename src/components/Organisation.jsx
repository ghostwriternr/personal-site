...
const experienceInfo = {
  orgs: {
    intuit: {
      ...
      images: [
        require("../images/organisations/intuit/bull.jpg").default,
        require("../images/organisations/intuit/code.jpg").default,
        require("../images/organisations/intuit/glasses.jpg").default,
        require("../images/organisations/intuit/hackathon.JPG").default,
        require("../images/organisations/intuit/last.JPG").default,
        require("../images/organisations/intuit/office.JPG").default,
        require("../images/organisations/intuit/seminar.jpg").default,
        require("../images/organisations/intuit/social.jpg").default
      ]
    },
    ezdi: {
      key: "ezdi",
      name: "ezDI, India",
      role: "Software Engineer Intern",
      headerImage: require("../images/organisations/ezdi/jump.png").default,
      description: [
      ...
      images: [
        require("../images/organisations/ezdi/office.jpg").default,
        require("../images/organisations/ezdi/desk.jpg").default,
        require("../images/organisations/ezdi/diu.png").default
      ]
    },
    auv: {
      key: "auv",
      ...
      headerImage: require("../images/organisations/auv/team.jpg").default,
      description: [
      ...
      images: [
        require("../images/organisations/auv/bot3.jpg").default,
        require("../images/organisations/auv/bot2.jpg").default,
        require("../images/organisations/auv/demo.jpg").default,
        require("../images/organisations/auv/pool.jpg").default,
        require("../images/organisations/auv/sparton.jpg").default
      ]
    },
    metakgp: {
      key: "metakgp",
      ...
      headerImage: require("../images/organisations/metakgp/aaron.jpg").default,
      description: [
    ...
    iitkgp: {
      ...
      role: "",
      headerImage: require("../images/organisations/iitkgp/illu.jpg").default,
      description: [],
      images: [
        require("../images/organisations/iitkgp/interiit.jpg").default,
        require("../images/organisations/iitkgp/prize.jpg").default,
        require("../images/organisations/iitkgp/bitwise.png").default,
        require("../images/organisations/iitkgp/drams.jpg").default,
        require("../images/organisations/iitkgp/robotix.jpg").default
      ]
    },
    tls: {
      key: "tls",
      ...
      headerImage: require("../images/organisations/tls/sf.jpg").default,
      description: [
      ...
      images: [
        require("../images/organisations/tls/host.jpg").default,
        require("../images/organisations/tls/sfgroup.jpg").default,
        require("../images/organisations/tls/shivani.jpg").default,
        require("../images/organisations/tls/flavors.jpg").default,
        require("../images/organisations/tls/kalidas.jpg").default,
        require("../images/organisations/tls/govs.png").default,
        require("../images/organisations/tls/tp.jpg").default,
        require("../images/organisations/tls/duddu.png").default,
        require("../images/organisations/tls/shibani.png").default
      ]
    }
  }
};
          ...
          >
            <div className="col-xs-offset-1 col-xs-10 col-md-offset-3 col-md-6">
              {experienceInfo.orgs[
                ...
                return (
                  <p className="actual-content" key={index}>
                    {paragraph}
                  </p>
                );
              })}
