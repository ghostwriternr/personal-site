...
class Shortcuts extends Component {
  ...
  render() {
    return (
      <div>
        <div
          id="placeholder-buttons"
          className="shortcuts mobile-invisible tablet-invisible tablet-landscape-invisible"
        >
        ...
        >
          {this.state.keys.map(function(key, index) {
            return (
              <Link
                to={key[Object.keys(key)[0]]}
                key={index}
                className={"shortcut " + this.isRoot()}
              >
                {Object.keys(key)[0]}
              </Link>
            );
