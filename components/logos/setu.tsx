...
function SvgComponent(props: JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement> & { theme: string }) {
    return (
        <svg
            id="prefix__Layer_1"
